...
function IpTunnelingConnection(instance, options) {
  instance.BindSocket = function (cb) {
    ...
    udpSocket.bind(function () {
      KnxLog.get().debug('IpTunnelingConnection.BindSocket %s:%d', instance.localAddress, udpSocket.address().port); // Make the local port accessible for other functions etc.
  ...
  instance.Connect = function () {
    let sm = this; // Check the return value
