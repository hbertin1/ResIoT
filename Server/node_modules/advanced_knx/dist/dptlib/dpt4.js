...
exports.formatAPDU = function (value) {
  if (!value) {
    ...
    if (typeof value === 'string') {
      let apduData = value.charCodeAt(0);
      if (apduData > 255) log.warn('DPT4: must supply an ASCII character');
...
exports.fromBuffer = function (buf) {
  if (buf.length !== 1) log.warn('DPT4: Buffer should be 1 byte long');else return String.fromCharCode(buf[0]);
};
