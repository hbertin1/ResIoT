...
exports.formatAPDU = function (value) {
  if (!value) log.warn('DPT3: cannot write null value');else {
    let apduData = Buffer.alloc(1);

    if (typeof value === 'object' && value.hasOwnProperty('decr_incr') && value.hasOwnProperty('data')) {
      apduData[0] = (value.decr_incr << 3) + (value.data & 0b00000111);
    } else {
