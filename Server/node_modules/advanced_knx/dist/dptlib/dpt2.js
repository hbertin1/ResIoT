...
*/
const log = require('log-driver').logger; // DPT2 frame description.
...
exports.formatAPDU = function (value) {
  if (!value) {
    ...
    if (typeof value === 'object' && value.hasOwnProperty('priority') && value.hasOwnProperty('data')) {
      apduData = (value.priority << 1) + (value.data & 0b00000001);
    } else {
