...
var _KnxDeviceResourceInformation = _interopRequireDefault(require("./RawMod/KnxDeviceResourceInformation"));
...
KnxConstants.RESPONSECODE = {
  NO_ERROR: 0x00,
  // E_NO_ERROR - The connection was established succesfully
  E_HOST_PROTOCOL_TYPE: 0x01,
  E_VERSION_NOT_SUPPORTED: 0x02,
  E_SEQUENCE_NUMBER: 0x04,
  E_CONNSTATE_LOST: 0x15,
  // typo in eibd/libserver/eibnetserver.cpp:394, forgot 0x prefix ??? "uchar res = 21;"
  E_CONNECTION_ID: 0x21,
  // - The KNXnet/IP server device could not find an active data connection with the given ID
  ...
  // - The requested connection options is not supported by the KNXnet/IP server device
  E_NO_MORE_CONNECTIONS: 0x24,
  //  - The KNXnet/IP server could not accept the new data connection (Maximum reached)
  E_DATA_CONNECTION: 0x26,
  // - The KNXnet/IP server device detected an erro concerning the Dat connection with the given ID
  E_KNX_CONNECTION: 0x27,
  // - The KNXnet/IP server device detected an error concerning the KNX Bus with the given ID
...
KnxConstants.APCICODES = {
  GroupValue_Read: 0b0000000000,
  // Multicast (Value: 0)
  GroupValue_Response: 0b0001000000,
  // Multicast (Value: 64)
  GroupValue_Write: 0b0010000000,
  // Multicast (Value: 128)
  PhysicalAddress_Write: 0b0011000000,
  // Broadcast (Value: 192)
  PhysicalAddress_Read: 0b0100000000,
  // Broadcast (Value: 256)
  PhysicalAddress_Response: 0b0101000000,
  // Broadcast (Value: 320)
  ADC_Read: 0b0110000000,
  // Unicast (Value: 384)
  ADC_Response: 0b0111000000,
  // Unicast (Value: 448)
  Memory_Read: 0b1000000000,
  // Unicast (Value: 512)
  Memory_Response: 0b1001000000,
  // Unicast (Value: 576)
  Memory_Write: 0b1010000000,
  // Unicast (Value: 640)
  UserMemory_Read: 0b1011000000,
  // Unicast (Value: 704)
  UserMemory_Respond: 0b1011000001,
  // Unicast (Value: 705)
  UserMemory_11_Write: 0b1011000010,
  // Unicast (Value: 706)
  UserMemory_5_Write: 0b1011000011,
  // Unicast (Value: 707)
  ManufacturerInformation_Read: 0b1011000101,
  // Unicast (709)
  ManufacturerInformation_Response: 0b1011000110,
  // Unicast (710)
  ManufacturerSpecificCommand: 0b1011111000,
  // Unicast (760 - 767) [Manufacturer Specific Area]
  DeviceDescriptor_Read: 0b1100000000,
  // Unicast (Value: 768)
  DeviceDescriptor_Response: 0b1101000000,
  // Unicast (Value: 832)
  Restart: 0b1110000000,
  // Unicast (Value: 896)
  AccessRights_Read: 0b1111010001,
  // Unicast (Value: 977)
  AccessRights_Response: 0b1111010010,
  // Unicast (Value: 978)
  AccessRightsKey_Write: 0b1111010011,
  // Unicast (Value: 979)
  AccessRights_Write: 0b1111010100,
  // Unicast (Value: 980)
  PropertyValue_Read: 0b1111010101,
  // Unicast (Value: 981)
  PropertyValue_Response: 0b1111010110,
  // Unicast (Value: 982)
  PropertyValue_Write: 0b1111010111,
  // Unicast (Value: 983)
  PropertyDescription_Read: 0b1111011000,
  // Unicast (Value: 984)
  PropertyDescription_Response: 0b1111011001,
  // Unicast (Value: 985)
  SystemID_Write: 0b1111100000,
  // Broadcast (Value: 992)
  SystemID_Read: 0b1111100001,
  // Broadcast (Value: 993)
...
KnxConstants.KNX_BITMASKS = {
  MSGTYPE_BITMASK: 0b11010000,
  // To get the message type
  TPCI_TYPE_BITMASK: 0b11000000,
  // To get the TPCI type
  TPCI_SEQNUM_BITMASK: 0b00111100,
  // To get the TPCI seqnum
  TPCI_UCD_TYPE_BITMASK: 0b00000011,
  // To get the TPCI.UCD type
...
KnxConstants.KNX_MSG_TYPES = {
  MSG_NORMAL: 0b10010000,
  // A normal KNX message
  MSG_EXTENDED: 0b00010000,
  // A extended KNX message
...
KnxConstants.KNX_MSG_LENS = {
  NORMAL_MAXLEN: 0x17,
  // Maxlen for normal messages
  NORMAL_MINLEN: 0x8,
  // Minlen for normal messages
  KNX_EXTENDED_MAXLEN: 0x107,
  // Maxlen for extended messages
  KNX_EXTENDED_MINLEN: 0x9,
  // Minlen for extended messages
...
KnxConstants.KNX_TPCI_SUBTYPES = {
  TPCI_UCD_CON: 0b00000000,
  // UCD connect request
  TPCI_UCD_DCON: 0b00000001,
  // UCD disconnect request
  TPCI_NCD_ACK: 0b00000010,
  // NCD acknowledge message
...
KnxConstants.KNX_DEV_RESOURCE_INFORMATION = _KnxDeviceResourceInformation.default;
/*
...
KnxConstants.RESOURCE_ACCESS_TYPES = {
  ALL: 0x00,
  // Use any way of access
  MEMORY: 0x01,
  // Prefer using direct memory access
  PROPERTY: 0x02,
  // Prefer using property access
  MEMORY_STRICT: 0x03,
  // Only use direct memory access
...
KnxConstants.KNX_LSM_CMDS = {
  NOP: 0x00,
  // NOP
  LoadApplication: 0x01,
  // Starts the application-load process
  CompleteLoadApplication: 0x02,
  // Declares the application as loaded (when in 'Loading' state)
  SpecialDataLoad: 0x03,
  // Transfers some data to the device - debugging/development
  UnloadApplication: 0x04 // Starts the application-unload process

}; // KNX RunStateMachine states

KnxConstants.KNX_RSM_STATES = {
  ApplicationHalted: 0x00,
  // Application halted - not running
  ApplicationRunning: 0x01,
  // Application running
