...
class KnxNetProtocol {
  ...
  static addHPAI(datagram, localAddress, localPort) {
    datagram.hpai = {
      protocol_type: _KnxConstants.default.PROTOCOL_TYPE.IPV4_UDP,
  ...
  static prepareDatagram(serviceType, cemi, seqnum, conContext) {
    ...
    KnxNetProtocol.addHPAI(datagram, conContext.localAddress, conContext.localPort); // Add all the other needed data depending on serviceType

    switch (serviceType) {
      case _KnxConstants.default.SERVICE_TYPE.TUNNELING_REQUEST:
      ...
      case _KnxConstants.default.SERVICE_TYPE.TUNNELING_ACK:
        KnxNetProtocol.addTunnState(datagram, conContext.channel_id, conContext.remoteEndpoint, seqnum);
        break;
    } // Return the datagram
  ...
  static sendTunnRequest(cemi, conContext, callback) {
    ...
    const finalCemi = {
      ...
      ctrl: cemi.ctrl != null ? {
        frameType: cemi.ctrl.frameType != null ? cemi.ctrl.frameType : 1,
        // default: standard frame
        repeat: cemi.ctrl.repeat != null ? cemi.ctrl.repeat : 1,
        // default: do NOT repeat
        broadcast: cemi.ctrl.broadcast != null ? cemi.ctrl.broadcast : 1,
        // default: broadcast
        priority: cemi.ctrl.priority != null ? cemi.ctrl.priority : 3,
        // default: low
        destAddrType: cemi.ctrl.destAddrType != null ? cemi.ctrl.destAddrType : 1,
        // default: groupaddr
        hopCount: cemi.ctrl.hopCount != null ? cemi.ctrl.hopCount : 6,
        // default: 6
        extendedFrame: cemi.ctrl.extendedFrame != null ? cemi.ctrl.extendedFrame : 0,
        // default: standard frame
        acknowledge: cemi.ctrl.acknowledge != null ? cemi.ctrl.acknowledge : 1,
        // default: send acknowledge
    ...
    conContext.handle('outbound_TUNNELING_REQUEST', KnxNetProtocol.prepareDatagram(_KnxConstants.default.SERVICE_TYPE.TUNNELING_REQUEST, finalCemi, null, conContext), callback);
  }

}

exports.default = KnxNetProtocol;