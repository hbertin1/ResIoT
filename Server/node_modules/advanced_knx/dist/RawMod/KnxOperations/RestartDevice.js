...
var _default = {
  ...
  restartDevice: async (target, source, conContext, errContext) => {
    return new Promise(async resolve => {
      ...
      let rawModErr;
      let connReq;
      let deviceRestartMsg; // This function validates the arguments
      ...
      const checkArguments = () => {
        ...
        const checkArgumentsDefined = () => {
          ...
          if (target == null || conContext == null) {
            ...
            rawModErr = errContext.createNewError.errorID(err, _Errors.default.UNDEF_ARGS);
      ...
      const forgeMessages = () => {
        deviceRestartMsg = _KnxMessageTemplates.default.deviceRestartRequest(target, source);
        ...
        return new Promise(resolve => {
          ...
          _KnxNetProtocol.default.sendTunnRequest(connReq, conContext, function (sendErr) {
            if (sendErr) {
              ...
              _KnxNetProtocol.default.sendTunnRequest(deviceRestartMsg, conContext, sendErr => {
                // Check for errors
                if (sendErr) {
                  // Create the RawModError object
                  rawModErr = errContext.createNewError(sendErr, null); // Push it onto the errorStack
