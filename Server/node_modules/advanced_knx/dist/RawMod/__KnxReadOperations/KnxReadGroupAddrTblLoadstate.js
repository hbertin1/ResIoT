...
var _KnxReadDevMem = _interopRequireDefault(require("./KnxReadDevMem"));
...
/********************************************************************************************
 * This file contains a function to read the group address table loadstate of an KNX device *
 ********************************************************************************************/
var _default = {
  /*
   * Function: KnxGetProgmodeStatus.readGroupAddrTblLoadState()
   *
   *      This function reads a devices group address table loadstate
  ...
  readGroupAddrTblLoadState: async (target, recvTimeout, conContext, errContext) => {
    return new Promise(async resolve => {
       ...
       */
      let val = await _KnxReadDevMem.default.readDevMem(target, conContext.options.physAddr, _KnxConstants.default.KNX_MEMORY_ADDRS.MEMORY_GROUP_ADDR_TBL_LOADSTATE_ADDR, 1, recvTimeout, conContext, errContext);
