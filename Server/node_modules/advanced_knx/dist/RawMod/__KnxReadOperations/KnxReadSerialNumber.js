...
var _default = {
  ...
  readSerialNumber: async (target, recvTimeout, maskVersion, conContext, errContext) => {
    return new Promise(async resolve => {
      // read the resource
      const val = await _KnxReadDeviceResource.default.readDeviceResource(target, null, maskVersion, 'DeviceSerialNumber', _KnxConstants.default.RESOURCE_ACCESS_TYPES.ALL, recvTimeout, conContext, errContext);
