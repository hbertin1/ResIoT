...
var _default = {
  ...
  readProgmodeStatus: async (target, recvTimeout, maskVersion, conContext, errContext) => {
    return new Promise(async resolve => {
      // read the resource
      const val = await _KnxReadDeviceResource.default.readDeviceResource(target, null, maskVersion, 'ProgrammingMode', _KnxConstants.default.RESOURCE_ACCESS_TYPES.ALL, recvTimeout, conContext, errContext);
