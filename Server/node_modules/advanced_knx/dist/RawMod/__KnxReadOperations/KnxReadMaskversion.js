...
var _default = {
  ...
  readMaskversion: async (target, source, recvTimeout, conContext, errContext) => {
    ...
    return new Promise(async resolve => {
      ...
      let dconnMsg;
      let timeoutRef;
      let devDescrResponseHandlerTemplate; // This function validates the arguments
      ...
      const forgeMessages = () => {
        ...
        devDescrReadReq = _KnxMessageTemplates.default.devDescrReadRequest(target, source);
      ...
      const prepareCustomMessageHandlerTemplates = () => {
        devDescrResponseHandlerTemplate = _CustomMessageHandlerTemplates.default.devDescrResponseTemplate(target, source || conContext.options.physAddr);
      ...
      const registerHandler = () => {
         ...
         */
        _CustomMsgHandlers.default.registerCustomMsgHandler(devDescrResponseHandlerTemplate, devDescrResponseHandler, conContext);
      }; // This function is later used to remove handlers registered below


      const removeHandlers = () => {
        _CustomMsgHandlers.default.removeCustomMsgHandler(devDescrResponseHandlerTemplate, conContext);
        ...
        return new Promise(resolve => {
          ...
          _KnxNetProtocol.default.sendTunnRequest(connReq, conContext, sendErr => {
            ...
            if (sendErr) {
              ...
              _KnxNetProtocol.default.sendTunnRequest(devDescrReadReq, conContext, sendErr => {
                // Check for errors
                if (sendErr) {
                  // Create the RawModError object
                  rawModErr = errContext.createNewError(sendErr, null); // Push it onto the errorStack
      ...
      const createRecvTimeout = resolve => {
        ...
        timeoutRef = setTimeout(() => {
          ...
          const errnum = errContext.addNewError(rawModErr); // Return the error number
