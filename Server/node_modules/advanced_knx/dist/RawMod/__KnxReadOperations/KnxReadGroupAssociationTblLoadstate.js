...
var _default = {
  ...
  readGroupAssociationTblLoadState: async (target, recvTimeout, conContext, errContext) => {
    return new Promise(async resolve => {
       ...
       */
      let val = await _KnxReadDevMem.default.readDevMem(target, conContext.options.physAddr, _KnxConstants.default.KNX_MEMORY_ADDRS.MEMORY_GROUP_ASSOCIATION_TBL_LOADSTATE_ADDR, 1, recvTimeout, conContext, errContext);
