...
var _default = {
  ...
  readDeviceAddress: async (recvTimeout, conContext, errContext) => {
    ...
    return new Promise(async resolve => {
      ...
      let timeoutRef; // This function validates the arguments
      ...
      const forgeMessages = () => {
        ...
        physicalAddressReadMsg = _KnxMessageTemplates.default.physicalAddressReadRequest();
      ...
      const physicalAddressResponseHandler = rawMsgJson => {
        ...
        timeoutRef = null;
        removeHandlers(); // Extract the source address and resolve

        resolve({
          error: 0,
          data: rawMsgJson.cemi.src_addr
        });
      ...
      const registerHandler = () => {
         ...
         */
        _CustomMsgHandlers.default.registerCustomMsgHandler({
          cemi: {
            dest_addr: _KnxAddress.default.strToBin(_KnxConstants.default.KNX_BROADCAST_ADDR),
            apdu: {
      ...
      const removeHandlers = () => {
        _CustomMsgHandlers.default.removeCustomMsgHandler({
          cemi: {
            dest_addr: _KnxAddress.default.strToBin(_KnxConstants.default.KNX_BROADCAST_ADDR),
            apdu: {
              apci: 'PhysicalAddress_Response'
      ...
      const sendPhysicalAddressRequest = () => {
        return new Promise(resolve => {
          ...
          _KnxNetProtocol.default.sendTunnRequest(physicalAddressReadMsg, conContext, sendErr => {
            // Check for errors
            if (sendErr) {
