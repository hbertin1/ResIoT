...
var _default = {
  ...
  readApplicationID: async (target, applicationIndex, recvTimeout, maskVersion, conContext, errContext) => {
    return new Promise(async resolve => {
      let resourceName; // Get the correct resource name
      ...
      const val = await _KnxReadDeviceResource.default.readDeviceResource(target, null, maskVersion, resourceName, _KnxConstants.default.RESOURCE_ACCESS_TYPES.ALL, recvTimeout, conContext, errContext);
