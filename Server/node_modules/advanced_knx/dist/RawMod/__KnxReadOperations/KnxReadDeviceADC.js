...
var _default = {
  ...
  readDeviceADC: async (target, source, channel, readCount, recvTimeout, conContext, errContext) => {
    ...
    return new Promise(async resolve => {
      ...
      let dconnMsg;
      let timeoutRef;
      let adcresponseHandlerTemplate; // This function validates the arguments
      ...
      const checkArguments = () => {
        ...
        const checkArgumentTypes = () => {
          if (target.constructor !== String || (source != null ? source.constructor !== String : false) || channel.constructor !== Number || readCount.constructor !== Number || recvTimeout.constructor !== Number) {
      ...
      const forgeMessages = () => {
        ...
        adcReadReq = _KnxMessageTemplates.default.adcReadRequest(target, source, channel, readCount);
      ...
      const prepareCustomMessageHandlerTemplates = () => {
        adcresponseHandlerTemplate = _CustomMessageHandlerTemplates.default.adcResponseTemplate(target, source || conContext.options.physAddr);
      ...
      const registerHandler = () => {
         ...
         */
        _CustomMsgHandlers.default.registerCustomMsgHandler(adcresponseHandlerTemplate, adcResponseHandler, conContext);
      }; // This function is later used to remove handlers registered below


      const removeHandlers = () => {
        _CustomMsgHandlers.default.removeCustomMsgHandler(adcresponseHandlerTemplate, conContext);
        ...
        return new Promise(resolve => {
          ...
          _KnxNetProtocol.default.sendTunnRequest(connReq, conContext, sendErr => {
            ...
            if (sendErr) {
              ...
              _KnxNetProtocol.default.sendTunnRequest(adcReadReq, conContext, sendErr => {
                // Check for errors
                if (sendErr) {
                  // Create the RawModError object
                  rawModErr = errContext.createNewError(sendErr, null); // Push it onto the errorStack
