 ...
 *                  RawMod.js                *
 *********************************************/
class KnxNetRebuildMessageBytes {
  /*
   *
  ...
  static rebuildMessageBytes(rawMsg) {
    ...
    if (rawMsg[knxMessageOffset] !== _KnxConstants.default.KNX_MSG_TYPES.MSG_POLL) {
      if ((rawMsg[knxMessageOffset] & _KnxConstants.default.KNX_BITMASKS.MSGTYPE_BITMASK) === _KnxConstants.default.KNX_MSG_TYPES.MSG_NORMAL) {
        /*
         * Calculate the total length of the KNX message and create a buffer to store the original message
         */
        knxMessageLength = _KnxConstants.default.KNX_MSG_LENS.NORMAL_MINLEN + rawMsg[knxMessageOffset + 6];
      ...
      } else if ((rawMsg[knxMessageOffset] & _KnxConstants.default.KNX_BITMASKS.MSGTYPE_BITMASK) === _KnxConstants.default.KNX_MSG_TYPES.MSG_EXTENDED) {
        /*
         * Calculate the total length of the KNX message and create a buffer to store the original message
         */
        knxMessageLength = _KnxConstants.default.KNX_MSG_LENS.KNX_EXTENDED_MINLEN + rawMsg[knxMessageOffset + 6];
        rawMsgBytes = Buffer.alloc(knxMessageLength);
        /*
         * Copy static bytes into the buffer
         */
...
exports.default = KnxNetRebuildMessageBytes;