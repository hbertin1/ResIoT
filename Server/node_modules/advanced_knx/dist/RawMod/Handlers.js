...
var _KnxNetProtocolExtra2 = _interopRequireDefault(require("./KnxNetProtocolExtra"));
 ...
 ************************************************/
const KnxNetProtocolExtra = new _KnxNetProtocolExtra2.default();

class RawModHandlers {
  /*
  ...
  static rawMsgHandler(rawMsg, rawMsgJson, conContext) {
     ...
     */
    if (rawMsgJson.service_type === _KnxConstants.default.SERVICE_TYPE.TUNNELING_REQUEST) {
      /*
       * Check if this message sets of any custom handlers (see checkCallCustomMsgHandler() below)
       */
      _CustomMsgHandlers.default.checkCallCustomMsgHandler(rawMsgJson, conContext);
...
exports.default = RawModHandlers;