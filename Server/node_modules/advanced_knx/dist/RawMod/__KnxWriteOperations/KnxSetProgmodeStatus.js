...
var _KnxWriteDeviceResource = _interopRequireDefault(require("./KnxWriteDeviceResource"));
...
var _default = {
  ...
  setProgmodeStatus: async (target, status, recvTimeout, maskVersion, conContext, errContext) => {
     ...
     */
    return _KnxWriteDeviceResource.default.writeDeviceResource(target, conContext.options.physAddr, maskVersion, 'ProgrammingMode', _KnxConstants.default.RESOURCE_ACCESS_TYPES.ALL, Buffer.from([status]), recvTimeout, conContext, errContext);
  }
};
