...
var _default = {
  ...
  setDeviceAddress: async (newAddr, conContext, errContext) => {
    ...
    return new Promise(async resolve => {
      ...
      let newAddrBuf; // This function validates the arguments
      ...
      const prepareNewAddr = () => {
        newAddrBuf = _KnxAddress.default.strToBin(newAddr); // Check the return value

        if (newAddrBuf == null) {
          err = new Error(_Errors.default.INVALID_NEWADDRESS.errorMsg);
          rawModErr = errContext.createNewError(err, _Errors.default.INVALID_NEWADDRESS.errorID);
      ...
      const forgeMessages = () => {
        ...
        physicalAddressWriteMsg = _KnxMessageTemplates.default.physicalAddressWriteRequest(_KnxAddress.default.Uint16AddrToUint8Arr(newAddrBuf));
      ...
      const sendPhysicalAddressWriteRequest = () => {
        return new Promise(resolve => {
          ...
          _KnxNetProtocol.default.sendTunnRequest(physicalAddressWriteMsg, conContext, sendErr => {
            // Check for errors
            if (sendErr) {
