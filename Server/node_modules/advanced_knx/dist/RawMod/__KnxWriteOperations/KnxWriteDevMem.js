  ...
  writeDevMem: async (target, source, address, data, recvTimeout, conContext, errContext) => {
    ...
    return new Promise(async resolve => {
      ...
      const checkArguments = () => {
        let errnum = 0; // This function check if all arguments are defined
        ...
        const checkArgumentTypes = () => {
          if (target.constructor !== String || (source != null ? source.constructor !== String : false) || address.constructor !== Array || data.constructor !== Buffer || recvTimeout.constructor !== Number) {
      ...
      const forgeMessages = () => {
        ...
        memWriteReq = _KnxMessageTemplates.default.memoryWriteRequest(target, source, address, data);
      ...
      const ncdNackMsgHandler = () => {
        ...
        _KnxNetProtocol.default.sendTunnRequest(dconnMsg, conContext, function (sendErr) {
          ...
          err = new Error(_Errors.default.TARGET_NOTACK.errorMsg);
          rawModErr = errContext.createNewError(sendErr, _Errors.default.TARGET_NOTACK.errorID);
          const errnum = errContext.addNewError(rawModErr);
          resolve(errnum);
        });
        ...
        return new Promise(resolve => {
          ...
          _KnxNetProtocol.default.sendTunnRequest(connReq, conContext, function (sendErr) {
            if (sendErr) {
              ...
              _KnxNetProtocol.default.sendTunnRequest(memWriteReq, conContext, function (sendErr) {
                if (sendErr) {
                  // Create the RawModError object
                  rawModErr = errContext.createNewError(sendErr, null); // Push it onto the errorStack
