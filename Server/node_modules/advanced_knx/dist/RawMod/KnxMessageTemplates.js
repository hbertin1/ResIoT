...
const KnxMessageTemplates = {
  ...
  generalTemplate: {
    msgCode: _KnxConstants.default.MESSAGECODES['L_Data.req'],
    ctrl: {
      frameType: 1,
      repeat: 0,
      broadcast: 1,
      priority: _KnxConstants.default.KNX_MSG_PRIORITY.SYSTEM,
      acknowledge: 0,
      confirm: 0,
      hopCount: 6,
      extendedFrame: 0,
      destAddrType: _KnxConstants.default.KNX_ADDR_TYPES.DEVICE
    },
    dest_addr: 0,
    src_addr: 0,
    apdu: {}
  ...
  ucdConnRequest: (destAddr, srcAddr) => {
    ...
    retVal.apdu.tpci = _KnxConstants.default.KNX_TPCI_TYPES.TPCI_UCD >> 2;
    retVal.apdu.tpciUcdType = _KnxConstants.default.KNX_TPCI_SUBTYPES.TPCI_UCD_CON;
    return retVal;
  },
  ...
  ucdDconnMsg: (destAddr, srcAddr) => {
    ...
    retVal.src_addr = srcAddr;
    retVal.apdu.tpci = _KnxConstants.default.KNX_TPCI_TYPES.TPCI_UCD >> 2;
    retVal.apdu.tpciUcdType = _KnxConstants.default.KNX_TPCI_SUBTYPES.TPCI_UCD_DCON;
    return retVal;
  },
  ...
  ncdAckMsg: (destAddr, srcAddr) => {
    ...
    retVal.dest_addr = destAddr;
    retVal.src_addr = srcAddr;
    retVal.apdu.tpci = _KnxConstants.default.KNX_TPCI_TYPES.TPCI_NCD >> 2;
    retVal.apdu.tpciNcdType = _KnxConstants.default.KNX_TPCI_SUBTYPES.TPCI_NCD_ACK;
    return retVal;
  },
  ...
  memoryWriteRequest: (destAddr, srcAddr, targetMemoryAddr, data) => {
    ...
    retVal.apdu.tpci = _KnxConstants.default.KNX_TPCI_TYPES.TPCI_NDP >> 2;
    return retVal;
  },
  ...
  physicalAddressReadRequest: () => {
    ...
    retVal.ctrl.destAddrType = _KnxConstants.default.KNX_ADDR_TYPES.GROUP;
    retVal.dest_addr = _KnxConstants.default.KNX_BROADCAST_ADDR;
...
var _default = KnxMessageTemplates;
