...
var _KnxNetRebuildMessageBytes = _interopRequireDefault(require("./KnxNetRebuildMessageBytes"));

var _KnxParseTpci = _interopRequireDefault(require("./KnxParseTpci"));
 ...
 *                           RawMod.js                           *
 ****************************************************************/
class KnxNetProtocolExtra extends _KnxNetProtocol.default {
  constructor() {
    super(); // Get the rebuildMessageBytes function

    this.rebuildMessageBytes = _KnxNetRebuildMessageBytes.default.rebuildMessageBytes;
    this.parseTpci = _KnxParseTpci.default.parseTpci;
  }
  /*
  ...
  sendAck(seqnum, conContext) {
    conContext.send(_KnxNetProtocol.default.prepareDatagram(_KnxConstants.default.SERVICE_TYPE.TUNNELING_ACK, null, seqnum, conContext));
  }
  /*
...
exports.default = KnxNetProtocolExtra;