...
exports.default = exports.RawModError = void 0;
...
exports.RawModError = RawModError;

class RawModErrorHandler {
  constructor() {
  ...
  createNewError(errorObject, referenceID) {
    ...
    const callerInfo = _callerId.default.getData(this.createNewError); // Return the new RarModError
...
exports.default = RawModErrorHandler;