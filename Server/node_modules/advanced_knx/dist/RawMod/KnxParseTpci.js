...
class KnxParseTpci {
  ...
  static parseTpci(tpci) {
    // Initialize retval
    let retval = ''; // Check if tpci is a Buffer, Array, ...
    ...
    const handleVarType = () => {
      ...
      if (typeof tpci === 'object') {
        ...
        tpci = tpci[0]; // Check if the new tpci is defined
    ...
    const checkTpciType = () => {
       ...
       */
      switch (tpci & _KnxConstants.default.KNX_BITMASKS.TPCI_TYPE_BITMASK) {
        case _KnxConstants.default.KNX_TPCI_TYPES.TPCI_UDP:
          retval = 'UDP_APCI';
          break;

        case _KnxConstants.default.KNX_TPCI_TYPES.TPCI_NDP:
          retval = 'NDP_APCI';
          break;

        case _KnxConstants.default.KNX_TPCI_TYPES.TPCI_UCD:
          retval = 'UCD_';
          break;

        case _KnxConstants.default.KNX_TPCI_TYPES.TPCI_NCD:
          retval = 'NCD_';
          break;
      }
    ...
    const checkTpciUcdType = () => {
      ...
      switch (tpci & _KnxConstants.default.KNX_BITMASKS.TPCI_UCD_TYPE_BITMASK) {
        case _KnxConstants.default.KNX_TPCI_SUBTYPES.TPCI_UCD_CON:
          retval = retval + 'CON';
          break;

        case _KnxConstants.default.KNX_TPCI_SUBTYPES.TPCI_UCD_DCON:
          retval = retval + 'DCON';
          break;
    ...
    const checkTpciNcdType = () => {
      ...
      switch (tpci & _KnxConstants.default.KNX_BITMASKS.TPCI_NCD_TYPE_BITMASK) {
        case _KnxConstants.default.KNX_TPCI_SUBTYPES.TPCI_NCD_ACK:
          retval = retval + 'ACK';
          break;

        case _KnxConstants.default.KNX_TPCI_SUBTYPES.TPCI_NCD_NACK:
          retval += 'NACK';
          break;
    ...
    const appendSeqnum = () => {
      return retval + ' Seqnum: ' + ((tpci & _KnxConstants.default.KNX_BITMASKS.TPCI_SEQNUM_BITMASK) >> 2).toString();
